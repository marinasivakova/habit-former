...
//#endregion
//#region src/shared/styles/globals.scss
...
var makeUserStorageKey = (userId, baseKey) => `${baseKey}-${userId}`;
//#endregion
//#region src/app/model/localStorageStore.ts
...
var useHabitsStore = create()((set) => ({
	...
	toggleHabitDone: (habitId, date = (/* @__PURE__ */ new Date()).toISOString().split("T")[0]) => {
		const userId = useAuthStore.getState().activeUserId;
		if (!userId) return;
		set((state) => {
...
//#endregion
//#region src/shared/ui/tokens/colors.ts
var colors = {
	dark: {
		background: "#121212",
		surface: "#1E1E2F",
...
//#endregion
//#region src/shared/ui/theme.tsx
...
//#endregion
//#region src/shared/ui/tokens/spacing.ts
var spacing = {
	xs: "4px",
	sm: "8px",
	md: "16px",
...
//#endregion
//#region src/shared/ui/tokens/typography.ts
...
//#endregion
//#region src/shared/ui/components/InputField.tsx
var InputField = ({ label, style, ...props }) => {
...
var Button = ({ variant = "primary", isActive = false, style, children, ...props }) => {
	...
	const themeStyles = {
		...
		color: variant === "primary" ? colors.text : void 0,
		fontFamily: typography.fontFamily,
		fontSize: typography.sizes.md,
...
//#endregion
//#region src/widgets/habitList/HabitList.tsx
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
				...
				children: (0, import_dayjs_min.default)(today).format("MMMM D, YYYY")
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CreateHabitModal, {}),
...
//#endregion
//#region src/shared/lib/RouteGuard.tsx
var RouteGuard = ({ children, requireAuth = true, redirectTo }) => {
	const activeUserId = useAuthStore((state) => state.activeUserId);
	if (requireAuth && !activeUserId) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Navigate, {
		to: redirectTo,
		replace: true
	});
	if (!requireAuth && activeUserId) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Navigate, {
...
function AppRoutes() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Routes, { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, {
			...
			element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RouteGuard, {
				redirectTo: ROUTES.AUTH,
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MainLayout, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HabitDetailPage, {}) })
			})
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, {
			path: ROUTES.AUTH,
...
function App() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BrowserRouter, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ThemeProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppRoutes, {}) }) });
}
//#endregion
//#region src/main.tsx
